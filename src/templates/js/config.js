var config = {
    ...
    coinUnitPlaces: 12,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Lakran
    txCoinbaseMinConfirms: 60, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Lakran
    coinSymbol: 'LAK',
    openAliasPrefix: "lak",
    coinName: 'Lakran',
